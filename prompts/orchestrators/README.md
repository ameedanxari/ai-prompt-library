...
| `revise-outputs.md` | Runs between the planning engine and the executor. Checks C1–C9 for coverage, schema, baseline completeness, external-services manifest, user-story linkage, platform coverage. |
