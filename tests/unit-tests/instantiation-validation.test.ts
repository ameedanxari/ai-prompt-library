  ...
  function writeUiSourceMap(dir: string) {
    fs.writeFileSync(
      ...
      [
        ...
        '|---|---|---|---|---|---|---|---|',
        '| REF-001 | existing-product | src/styles/theme.css | design tokens | local file available in repo | 2026-05-29 | inspected | current theme source |',
        '| REF-002 | existing-product | src/components/Button.tsx | interactive controls | local file available in repo | 2026-05-29 | inspected | current component source |',
        '| REF-003 | free-reference-site | Public admin analytics references | dashboard scan pattern | research-unavailable: fixture documents fallback because external service is unavailable in unit tests | 2026-05-29 | fallback | unit-test fallback evidence |',
        '',
        '## Reference Map',
