...
export class TestingFrameworkTemplateValidator extends TemplateValidator {
  constructor(modulePath: string = 'prompts/modules/testing') {
    super(modulePath);
  }
  ...
  validateMobileScreenshotUITestingTemplate(): MobileScreenshotUITestingTemplateStructure {
    const templatePath = join(this.moduleDir, 'mobile-screenshot-ui-testing.md');
  ...
  private getEmptyTemplateContent(): TestingTemplateContent {
    return this.getEmptyContent<TestingTemplateContent>(['hasPurposeSection', 'hasContextSection', 'hasImplementationPatterns', 'hasConfigurationExamples', 'hasIntegrationPoints', 'hasSecurityConsiderations', 'hasTestingConsiderations', 'hasCodeExamples', 'hasCoreComponents']);
  }
  ...
  validateTestingFeatureCoverage(): {
    ...
    const testAutomationPath = join(this.moduleDir, 'test-automation.md');
    const testDataPath = join(this.moduleDir, 'test-data-management.md');
    const performancePath = join(this.moduleDir, 'performance-testing.md');
    const securityPath = join(this.moduleDir, 'security-testing.md');
    ...
    const mobileScreenshotPath = join(this.moduleDir, 'mobile-screenshot-ui-testing.md');
