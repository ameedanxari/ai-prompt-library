...
export class DataProcessingTemplateValidator extends TemplateValidator {
  constructor(modulePath: string = 'prompts/modules/data-processing') {
    super(modulePath);
  }
  ...
  private getEmptyTemplateContent(): DataProcessingTemplateContent {
    return this.getEmptyContent<DataProcessingTemplateContent>(['hasPurposeSection', 'hasContextSection', 'hasImplementationPatterns', 'hasConfigurationParameters', 'hasIntegrationPoints', 'hasTestingConsiderations', 'hasSecurityConsiderations', 'hasCodeExamples', 'hasDataModels']);
  }
  ...
  validateDataProcessingFeatureCoverage(): {
    ...
    const ingestionPath = join(this.moduleDir, 'data-ingestion.md');
    const transformationPath = join(this.moduleDir, 'data-transformation.md');
    const qualityPath = join(this.moduleDir, 'data-quality.md');
    const governancePath = join(this.moduleDir, 'data-governance.md');
