...
echo "🟢 Reset complete."
echo ""
echo "Next: open your IDE/agent and say 'run the drill-down engine on MY_PROJECT.md'."
echo "      The agent will read AGENTS.md, run the engine, and write to prompts/outputs/current/."
